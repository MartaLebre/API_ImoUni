...
class Casa extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['nome_rua', 'tipo_alojamento', 'wifi', 'limpeza', 'capacidade', 'num_quartos', 'num_wcs', 'aquecimento_agua', 'area_exterior', 'animais', 'fumar', 'visitantes_pernoitar', 'foto'], 'required'],
            [['localizacao', 'tipo_alojamento', 'limpeza', 'aquecimento_agua', 'foto'], 'string'],
